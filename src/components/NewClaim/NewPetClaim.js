...
import { addNewClaim, addNewPetClaim } from "../../data/DataFunctions";
...
const NewPetClaim = () => {
    ...
    const emptyClaim = {
        ...
        amount: "", reason: "", description: "", type: "", breed: ""
    }
    ...
    const {policyNumber, insuranceType, startedDate, customerName, amount, reason, description, type, breed} = newClaim;
    ...
    const submitForm = (e) => {
        ...
        const response = addNewPetClaim(user.username, user.password, newClaim);
    ...
    return (
        <form className="newClaimForm" onSubmit={submitForm} >
           ...
           <input type="text" id="tyep" onChange={handleChange} value={type} />
           <br />
           <label htmlFor="breed">Breed</label>
           <input type="text" id="breed" onChange={handleChange} value={breed} />
           <br />
