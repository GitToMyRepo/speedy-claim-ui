...
import { addNewClaim, addNewMotorClaim } from "../../data/DataFunctions";
...
const NewMotorClaim = () => {
    ...
    const emptyClaim = {
        ...
        amount: "", reason: "", description: "", make: "", model: "", year: ""
    }
    ...
    const {policyNumber, insuranceType, startedDate, customerName, amount, reason, description, make, model, year} = newClaim;
    ...
    const submitForm = (e) => {
        ...
        const response = addNewMotorClaim(user.username, user.password, newClaim);
    ...
    return (
        <form className="newClaimForm" onSubmit={submitForm} >
           ...
           <br />
           <label htmlFor="description">Make</label>
           <input type="text" id="description" onChange={handleChange} value={make} />
           <br />
           <label htmlFor="description">Model</label>
           <input type="text" id="description" onChange={handleChange} value={model} />
           <br />
           <label htmlFor="description">Year</label>
           <input type="text" id="description" onChange={handleChange} value={year} />
           <br />
