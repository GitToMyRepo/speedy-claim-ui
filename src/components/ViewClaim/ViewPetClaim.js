...
const ViewPetClaim= (props) => {
    ...
    amount : "", reason: "", desription : "", type : "", breed: ""}
        ...
        <Fragment>
            ...
            <table className="claimsTable" >
                <tbody>
                    ...
                    <tr><th>Type</th><td>{claim.type}</td></tr>
                    <tr><th>Breed</th><td>{claim.breed}</td></tr>
                </tbody>
            </table>
            {showEditButton()} 
        </Fragment>
